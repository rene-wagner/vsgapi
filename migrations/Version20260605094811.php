 ...
 */
final class Version20260605094811 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE media_folder (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, storage_path VARCHAR(512) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, parent_id INT DEFAULT NULL, INDEX IDX_50DB9313727ACA70 (parent_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE media_item (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, original_filename VARCHAR(255) NOT NULL, mime_type VARCHAR(127) NOT NULL, extension VARCHAR(16) NOT NULL, type VARCHAR(255) NOT NULL, size_bytes INT NOT NULL, path VARCHAR(512) NOT NULL, thumbnail_path VARCHAR(512) DEFAULT NULL, description LONGTEXT DEFAULT NULL, crop_x INT DEFAULT NULL, crop_y INT DEFAULT NULL, crop_width INT DEFAULT NULL, crop_height INT DEFAULT NULL, is_hidden_in_api TINYINT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, folder_id INT DEFAULT NULL, category_id INT DEFAULT NULL, INDEX IDX_DC5CFACD162CB942 (folder_id), INDEX IDX_DC5CFACD12469DE2 (category_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE membership_application (id INT AUTO_INCREMENT NOT NULL, first_name VARCHAR(100) NOT NULL, last_name VARCHAR(100) NOT NULL, membership_application_pdf_filename VARCHAR(255) NOT NULL, membership_application_pdf_path VARCHAR(512) NOT NULL, supervision_duty_pdf_filename VARCHAR(255) DEFAULT NULL, supervision_duty_pdf_path VARCHAR(512) DEFAULT NULL, created_at DATETIME NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
