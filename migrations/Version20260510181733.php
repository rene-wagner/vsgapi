 ...
 */
final class Version20260510181733 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $trainingSessions = $this->loadJson(
            "department_training_sessions.json",
        );
        ...
        foreach ($contentBlocks as $row) {
            $this->addSql(
                ...
                [$row["pk"], $row["id"], $row["url"], $row["content"]],
            );
        }
        ...
        $autoIncrement = [
            ...
            "department_training_group" =>
                max(array_column($trainingGroups, "id")) + 1,
            "department_training_session" =>
        ...
        foreach ($autoIncrement as $table => $nextId) {
            $this->addSql(
                sprintf("ALTER TABLE %s AUTO_INCREMENT = %d", $table, $nextId),
            );
        }
    }
